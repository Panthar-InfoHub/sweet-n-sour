          ...
          <div className="prose prose-green max-w-none space-y-6">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                order for any reason. Payment must be received before order processing begins.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                and shipping method selected. We are not responsible for delays caused by shipping carriers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Please refer to our Return & Refund Policy for detailed information about returns, exchanges, and
                refunds.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall we be liable for any damages arising out of the use or inability to use our products
